            ...
            <div>
              ...
              <div className=" text-xl mt-4 text-gray-400">
                <p>
                  ...
                  a payment may have originated, or to safeguard our services
                  from API abuse or automated software agents. We may make
                  automatic decisions about you for those purposes, which may
                  result in the Travel Supplier with whom you are booking
                ...
                <p>
                  ...
                  we can identify and correct flaws with our services or areas
                  for improvement
                </p>
                <br />
                <p>
                  ...
                  for any issues you may have with a flight, hotel, or another
                  travel service you've booked through Trippybug, if you or the
                  Travel Provider contact us about a problem with your booking,
                ...
                <p>
                  ...
                  the purposes of commercial statistics and business analytics,
                  measuring the number of users who switch to, or book trips
                  with, Travel Operators, as well as the details of the
                ...
                <p>
                  ...
                  which you are unable to provide the license described in
                  paragraph 2 below.
                </p>
                <br />
                <p>
                  ...
                  the TrippyBug Group Companies a non-exclusive, perpetual,
                  royalty-free, worldwide, transferable, and sub-licensable
                  right to host, use, reproduce both electronically and
                  otherwise, publicly display, distribute, modify, adapt,
                  publish, translate, and create derision from your User
                  Content. We may, for example, make User Content available to
                  our commercial partners or other TrippyBug Group Companies for
                  use on their own websites. You own the User Content you post
                  to the TrippyBug Services, and you can cancel this license at
                  any time by deleting the User Content or your TrippyBug
                  account. User Content that has been deleted will be removed
                  within 48 hours.
                </p>
                <br />
                <p>
                ...
                <p>
                  ...
                  and recognize that we are free to use and use the feedback for
                  any purpose. You can give us feedback by using the 'feedback'
                  page or contacting our customer support.
                </p>
                <br />
                ...
                <ul className=" pt-10 list-disc  pl-10 flex flex-col gap-10 ">
                  ...
                  <li>
                    ...
                    corresponding product feature or by contacting us.
                  </li>
                </ul>
                <br />
                <b>
                  We need to use or comply with our own legal rights or
                  obligations.
                </b>
                <br />
                <br />
                <p>
                  ...
                  by law or if a court order or regulatory authority requires
                  it. In addition, if you exercise any applicable legal right of
                  access, correct, or delete your personal information, we may
                  ask for identification and verification papers to establish
                  your identity.
                </p>
              </div>
            </div>
