...
const galleryPhotoRef = createRef<Slider>();
  ...
  return (
    <div className="relative p-10 container">
      ...
      {Array.from(Array(Math.floor(posts?.length / 5))).map((_, index) => (<div className="relative flex lg:hidden flex-col gap-6" key={index}>
        <div className=" relative grid grid-cols-12 gap-4">
        {posts[index*5+0]?.node?.featuredImage?.node?.sourceUrl && <div className="col-span-3  w-full relative min-h-[260px] rounded-md overflow-hidden ">
            <Image
              onClick={() => setPhotoIndex(index*5+0)}
              alt=""
              src={posts[index*5+0]?.node?.featuredImage?.node?.sourceUrl}
              objectFit="cover"
              layout="fill"
            />
          </div>}
          {posts[index*5+1]?.node?.featuredImage?.node?.sourceUrl &&<div className="col-span-9  w-full relative min-h-[260px] rounded-md overflow-hidden">
            <Image
              onClick={() => setPhotoIndex(index*5+1)}
              alt=""
              src={posts[index*5+1]?.node?.featuredImage?.node?.sourceUrl}
              objectFit="cover"
              layout="fill"
            />
          </div>}
          {posts[index*5+2]?.node?.featuredImage?.node?.sourceUrl && <div className="col-span-12  w-full relative min-h-[260px] rounded-md overflow-hidden">
            <Image
          ...
          {posts[index*5+3]?.node?.featuredImage?.node?.sourceUrl && <div className="col-span-8  w-full relative min-h-[260px] rounded-md overflow-hidden">
            <Image
          ...
          {posts[index*5+4]?.node?.featuredImage?.node?.sourceUrl &&<div className="  col-span-9  w-full relative flex-1 min-h-[260px] rounded-md overflow-hidden">
              <Image
            ...
            <div className="hidden lg:flex gap-4 justify-between" key={index}>
              <div className="flex-1 grid gap-4 ">
                <div className=" col-span-12 flex flex-col gap-4">
                  ...
                  {posts[index*9+0]?.node?.featuredImage?.node?.sourceUrl && <div className="col-span-9  w-full relative min-h-[260px] rounded-md overflow-hidden">
                    <Image
                      onClick={() => setPhotoIndex(index * 9 + 0)}
                      alt=""
                      src={posts[index*9+0]?.node?.featuredImage?.node?.sourceUrl}
                      objectFit="cover"
                      layout="fill"
                    />
                  </div>
                ...
                {posts[index*9+1]?.node?.featuredImage?.node?.sourceUrl && <div className="col-span-8  relative min-h-[260px] rounded-md overflow-hidden">
                  <Image
                    onClick={() => setPhotoIndex(index * 9 + 1)}
                    alt=""
                    src={posts[index*9+1]?.node?.featuredImage?.node?.sourceUrl}
                    objectFit="cover"
                    layout="fill"
                  />
                </div>
      }
                  {posts[index*9+2]?.node?.featuredImage?.node?.sourceUrl &&<div className="col-span-4  relative min-h-[260px] rounded-md overflow-hidden">
                  <Image
                    onClick={() => setPhotoIndex(index * 9 + 2)}
                    alt=""
                    src={posts[index*9+2]?.node?.featuredImage?.node?.sourceUrl}
                    objectFit="cover"
                    layout="fill"
                  />
                </div>
              ...
              <div className=" flex-1">
                ...
                {posts[index*9+3]?.node?.featuredImage?.node?.sourceUrl &&<div className="col-span-12  relative min-h-[260px] rounded-md overflow-hidden">
                    <Image
                      onClick={() => setPhotoIndex(index * 9 + 3)}
                      alt=""
                      src={posts[index*9+3]?.node?.featuredImage?.node?.sourceUrl}
                      objectFit="cover"
                      layout="fill"
                    />
                  </div>
}
{posts[index*9+4]?.node?.featuredImage?.node?.sourceUrl && <div className="col-span-6  relative min-h-[260px] rounded-md overflow-hidden">
                    <Image
                      onClick={() => setPhotoIndex(index * 9 + 4)}
                      alt=""
                      src={posts[index*9+4]?.node?.featuredImage?.node?.sourceUrl}
                      objectFit="cover"
                      layout="fill"
                    />
                  </div>
                  ...
                  <div className="col-span-6  relative min-h-[260px] rounded-md overflow-hidden">
                    <Image
                      ...
                      alt=""
                      src={posts[index*9+5]?.node?.featuredImage?.node?.sourceUrl}
                      objectFit="cover"
                      layout="fill"
                    />
                  </div>
              ...
              <div className="relative flex flex-col items-end justify-end flex-1">
                ...
                {posts[index*9+6]?.node?.featuredImage?.node?.sourceUrl &&<div className="col-span-4 relative min-h-[260px] rounded-md overflow-hidden">
                    <Image
                      onClick={() => setPhotoIndex(index * 9 + 6)}
                      alt=""
                      src={posts[index*9+6]?.node?.featuredImage?.node?.sourceUrl}
                      objectFit="cover"
                      layout="fill"
                    />
                  </div>
                  ...
                  <div className="col-span-8  relative min-h-[260px] rounded-md overflow-hidden">
                    <Image
                      ...
                      alt=""
                      src={posts[index*9+7]?.node?.featuredImage?.node?.sourceUrl}
                      objectFit="cover"
                      layout="fill"
                    />
                  </div>
                  ...
                  {posts[index*9+8]?.node?.featuredImage?.node?.sourceUrl &&<div className="  col-span-9  w-full relative flex-1 min-h-[260px] rounded-md overflow-hidden">
                      <Image
                        onClick={() => setPhotoIndex(index * 9 + 8)}
                        alt=""
                        src={posts[index*9+8]?.node?.featuredImage?.node?.sourceUrl}
                        objectFit="cover"
                        layout="fill"
                      />
                    </div>
        ...
        >
          <div className="flex flex-col max-h-screen min-h-screen">
            ...
            <div className="flex flex-col">
                ...
                {currentPost && <div className="max-w-6xl flex flex-col gap-4">
                    ...
                    <div
                      ...
                      dangerouslySetInnerHTML={{
                        __html: `${currentPost?.node?.excerpt.slice(0,100)}...`,
                      }}
                    />
                  </div>}
                </div>
