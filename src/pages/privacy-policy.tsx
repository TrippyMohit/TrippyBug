        ...
        <div className=" z-30 relative w-full min-h-screen gap-10 m-auto flex flex-col-reverse lg:flex-row lg:mt-10 container px-10 lg:p-0">
          ...
          <div className=" flex flex-col lg:w-3/4 w-full  mt-7 overflow-scroll scroll max-h-screen scrollbar-hide pb-10">
            <div className="flex  flex-col gap-7">
              <div className="flex flex-col gap-3">
                ...
                <div className=" text-xl  text-gray-400">
                  <p>
                    ...
                    {` provides a space for the client and the customer respecting their privacy commits to keep the personal document confidential. The company only collects, uses, and filters the obtained information according to its requirements. `}
                  </p>
                </div>
              </div>
              <div className="flex flex-col gap-3">
              ...
              <div className="flex flex-col gap-3">
                <h1 className="font-sans font-bold text-4xl" id="contact-us">
                  Contact Us
                </h1>
                <div className=" text-xl  text-gray-400">
                  <p>
