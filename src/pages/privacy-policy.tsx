...
export default function PrivacyPolicy() {
  const tableOfContentItems = [
    ...
    {
      title:
        "Approaching you to invite you to take part in genuine market research",
      link: "#use",
    },
    {
      title: "Contact Us",
    ...
    <div className="w-full relative ">
      <div>
        <div className=" z-30 relative w-full min-h-screen gap-10 m-auto flex flex-col-reverse lg:flex-row lg:mt-10 container px-4 sm:px-10 lg:p-0">
          ...
          <div className=" flex flex-col lg:w-3/4 w-full  mt-7 overflow-scroll scroll sm:max-h-screen scrollbar-hide pb-10">
            <div className="flex  flex-col gap-7">
              <div className="flex flex-col gap-3">
                ...
                <div className=" text-xl  text-gray-400">
                  <p className="text-sm sm:text-lg">
                    <a href="https://trippybug.com/">Trippybug</a>{" "}
                    {` provides a space for the client and the customer respecting their privacy commits to keep the personal document confidential. T2e company only collects, uses, and filters the obtained information according to its requirements. `}
                  </p>
                </div>
              </div>
              <div className="flex flex-col gap-3">
              ...
              <div className="flex flex-col gap-3">
                ...
                <div className=" text-xl  text-gray-400">
                  <p className="text-sm sm:text-lg">
                    ...
                    locale, dialect information, and site layout activity, we
                    identify and correct flaws with our services or areas for
                    improvement, offering you customer support or assistance in
                    response to any queries or problems you may have while
                    utilising our services. Although the ultimate Travel
                    Supplier is responsible to you for any issues you may have
                    with a flight, hotel, or another travel service you & a
                    positive booked through Trippybug, if you or the Travel
                    Provider contact us about a problem with your booking, we"ll
                    need to use some of your personal data for client
                    satisfactory agendas.
                  </p>
                </div>
                <div className=" text-xl  text-gray-400">
                  <p className="text-sm sm:text-lg">
                ...
                <p className="text-sm sm:text-lg text-gray-400">
                  <a href="https://trippybug.com/">Trippybug</a>{" "}
                  {` create a profile and history of your behaviour and a timeline on our services to customise your experience. In every way , we take great effort to ensure that none of our activities include any profiling or automatic decision-making that could have legal or other severe consequences for you.`}
                </p>
                <p className=" text-sm sm:text-lg text-gray-400">
              ...
              <div className="flex flex-col gap-3" id="use">
                <h2 className="font-sans font-bold text-3xl sm:text-4xl">
                  Approaching you to invite you to take part in genuine market
                  research
                </h2>
