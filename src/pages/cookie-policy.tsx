          ...
          <div className=' flex flex-col lg:w-3/4 w-full  mt-7 overflow-scroll scroll max-h-screen scrollbar-hide pb-10'>
            <div className='flex  flex-col gap-7'>
              <div className='flex flex-col gap-3'>
                ...
                <h1 className='font-sans mt-24 font-bold text-4xl'>Introduction</h1>
              ...
              <div className='flex flex-col gap-3' id='what-is-a-cookie'>
                <h1 className='font-sans font-bold text-4xl'>What is a Cookie?</h1>
                <div className=' text-xl  text-gray-400'>
                  <p>
              ...
              <div className='flex flex-col gap-3' id='why-do-we-use-cookies'>
                <h1 className='font-sans font-bold text-4xl'>Why do we use cookies?</h1>
                <div className=' text-xl  text-gray-400'>
                  <p>
              ...
              <div className='flex flex-col gap-3' id='cookies-work'>
                <h1 className='font-sans font-bold text-4xl'>How do cookies work?</h1>
                <div className=' text-xl  text-gray-400'>
                  <p>
              ...
              <div className='flex flex-col gap-3' id='incharge'>
                <h1 className='font-sans font-bold text-4xl'>Who is in charge of cookies and other related technologies?</h1>
                <div className=' text-xl  text-gray-400'>
                  <p>
              ...
              <div className='flex flex-col gap-3' id='kind'>
                <h1 className='font-sans font-bold text-4xl'>What kinds of cookies and other technologies do we employ?</h1>
                <div className=' text-xl  text-gray-400'>
                  <p>
              ...
              <div className='flex flex-col gap-3' id='essential'>
                <h1 className='font-sans font-bold text-4xl'>The Essentials</h1>
                <div className=' text-xl  text-gray-400'>
                  <p>
...
`}                  </p>
                ...
                <div className=' text-xl  text-gray-400'>
                  <ul className=' pt-10 list-disc  pl-10 flex flex-col gap-10 '>
                    ...
                    `}</li>
                    <li>{`As you go between pages, we'll remember your search parameters – such as routes, dates, and the number of passengers – in order to pass this information on to the travel providers you're redirected to from Trippybug, or to send you to specific locations inside our app or on our site. `}</li>
                    <li>{`
                    ...
                    <li> {`
                   Login functionality and customer support services are provided.      `}</li>
                  </ul>
                </div>
              </div>
              <div className='flex flex-col gap-3' id='how-to-opt-out'>
                <h1 className='font-sans font-bold text-4xl'>How do I opt out?</h1>
                <div className=' text-xl  text-gray-400'>
                  <p>
